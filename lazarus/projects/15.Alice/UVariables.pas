...
uses sysutils;
  ...
  Procedure TMemory.Save;
    ...
    begin
      ...
      writeln('variables : Saving variables for the bot '+bot_id);
      try
        Vars.SaveToFile(filename);
      except
        writeln('variables : Error while saving variables');
      end;
    end;
  Procedure TMemory.Load;
    ...
    begin
      ...
      if fileexists(filename) then begin
        writeln('variables : Loading variables for the bot '+bot_id);
