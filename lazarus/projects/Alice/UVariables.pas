...
uses sysutils,frm_Main;
  ...
  Procedure TMemory.Save;
    ...
    begin
      ...
      frmMain.Log('variables : Saving variables for the bot '+bot_id);
      try
        Vars.SaveToFile(filename);
      except
        frmMain.Log('variables : Error while saving variables');
      end;
    end;
  Procedure TMemory.Load;
    ...
    begin
      ...
      if fileexists(filename) then begin
        frmMain.Log('variables : Loading variables for the bot '+bot_id);
