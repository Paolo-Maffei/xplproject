...
type
  TBotElement=class(TTEmplateElement)
    function Process(Match:TMatch;Parser:TXMLParser):ansistring;override;
...
type
  ...
  function TSetElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      name:string;
    begin
  ...
  function TBotElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TGetElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TxStarElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      context:integer;
      index:string;
    begin
  ...
  function TDefaultElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      ...
      //result:=StrLCopy(@result,Parser.CurStart,Parser.CurFinal-Parser.CurStart+1);
    end;
  ...
  function TLearnElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:='';
  ...
  function TSrElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      temp:TMatch;
    begin
  ...
  function TThinkElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TSraiElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      temp:TMatch;
    begin
      result:=ProcessContents(Match,Parser);
  ...
  function TRandomElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      Options:Tlist;
      //Start:PChar;
      continue:PChar;
  ...
  function TConditionElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      mainval:string;
      mainvar:string;
    begin
  ...
  function TBrElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:=' ';
    end;
  ...
  function TCaseElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
  ...
  function TThatElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      thisTag:string;
    begin
  ...
  function TVersionElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TIdElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:='0';
      SkipElement(Parser);
    end;
  ...
  function TSizeElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TDateElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TGossipElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:=ProcessContents(Match,Parser);
  ...
  function TInputElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    var
      thisTag:string;
      i:integer;
      si:string;
  ...
  function TSubstElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TJScriptElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
  ...
  function TSystemElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:=Parser.CurAttr.Value('alt');;
  ...
  function TForgetElement.Process(Match:TMatch;Parser:TXMLParser):ansistring;
    begin
      result:='';
      SkipElement(parser);
      Memory.ClearVars;
