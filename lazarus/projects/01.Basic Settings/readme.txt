...
1.1.1 
   ...
   Plugins directory is created if it doesn't already exists (new machines 
   only problem)
...
1.1.3 
   Adding of logging directory in order to centralize logging system.
...
1.1.5
   ...
   Added configuration directory to prepare storage of app conf in a 
   centralized point 
