...
1. Description
   ...
   FUNDAMENTALS UTILITIES contains:
   ...
   DataStructs\
       ...
       cSparseArrays.pas    Sparse array classes
   ...
   Internet\
       ...
       cURL.pas             URL functions and classes
   XML\
...
3. Installation
   ...
   2. Open the package file "Fundamentals3_UtilitiesD#.dpk" from Delphi
      (where # is your version of Delphi);
      and Install.

      Or just add the units to your project as you need them.
...
5. Copyright information
   ...
   These units are copyrighted by the author (c) 1995-2004.
