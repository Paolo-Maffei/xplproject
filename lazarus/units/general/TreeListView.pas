{**
  ...
  $Revision: 109 $
  @lastmod $Date: 2008-08-30 22:15:22 +0200 (Sa, 30 Aug 2008) $
...
begin
  ...
  if defaultDraw then
    if y>listView.F_Header.Height then begin
      //clearing
      listView.Canvas.FillRect(classes.rect(0,yold,listView.ClientWidth-listview.f_vscroll.width,y));
      ...
      if listView.focused = self then
        DrawFocusRect( listView.Canvas.Handle,classes.rect(0,yold,listView.ClientWidth-listView.F_VScroll.Width,y));
  ...
  case message.Msg of
    ...
    LM_MOUSEMOVE: begin
      ...
      if (F_ClickedItem<>nil) and (multiSelect) and   // \/ left or right, not both
        ...
        F_RealMousePos:=classes.point(TLMMouseMove(message).XPos+F_HScroll.Position,
