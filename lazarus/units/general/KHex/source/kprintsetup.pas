...
begin
  ...
  begin
    ...
    try
      ...
      FPageSetup.MarginBottom := StrToFloatDef(EDBottom.Text, FPageSetup.MarginBottom);
      FPageSetup.MarginLeft := StrToFloatDef(EDLeft.Text, FPageSetup.MarginLeft);
      FPageSetup.MarginRight := StrToFloatDef(EDRight.Text, FPageSetup.MarginRight);
      FPageSetup.MarginTop := StrToFloatDef(EDTop.Text, FPageSetup.MarginTop);
    finally
