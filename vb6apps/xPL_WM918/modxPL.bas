...
Public Type Weather_InfoType
    Time_Humidity As String
    Temperature As String
    Barometer_Dew As String
    Rain As String
    Wind_General As String
End Type

Public Weather As Weather_InfoType

Public Type Weather_AlarmType
    Time_Hour As Double
    Time_Minute As Double
    Time_Set As Boolean
    
    Humidity_In_Hi As Double
    Humidity_In_Lo As Double
    Humidity_In_Set As Boolean
    Humidity_In_Current As Double
    
    Humidity_Out_Hi As Double
    Humidity_Out_Lo As Double
    Humidity_Out_Set As Boolean
    Humidity_Out_Current As Double
    
    Temp_In_Hi As Double
    Temp_In_Lo As Double
    Temp_In_Set As Boolean
    Temp_In_Current As Double
    
    Temp_Out_Hi As Double
    Temp_Out_Lo As Double
    Temp_Out_Set As Boolean
    Temp_Out_Current As Double
    
    Dewpt_In As Double
    Dewpt_In_Current As Double
    Dewpt_Out As Double
    Dewpt_Out_Current As Double
    Dewpt_Set As Boolean
    
    Barometer As Double
    Barometer_Set As Boolean
    Barometer_Current As Double
    
    Rain As Double
    Rain_Set As Boolean
    Rain_Current As Double
    
    Wind As Double
    Wind_Set As Boolean
    Wind_Current As Double
    
    Chill As Double
    Chill_Set As Boolean
    Chill_Current As Double
    
    Power_Battery As Boolean
    Power_Low As Boolean
    
End Type

Public Alarms As Weather_AlarmType
