...
Public ProbeType As Boolean

Public Type ProbeStruc
    ZoneName As String
    ProbeNames(6) As String
    HiAlert(2) As Double
    LoAlert(2) As Double
End Type

Public Probes(8) As ProbeStruc

Public ProbeQueue() As String
Public ResponseWait As Boolean

Public Type ProbeAutoStruc
    ZoneName As String
    ProbeName As String
    Interval As Long
    Counter As Long
...
Public ProbeAutos(16) As ProbeAutoStruc
...
extract_next_part:
    ...
    If xPL_Bodies = 0 Then
        Select Case xPL_Message(0).Section
        Case "XPL-CMND"
        Case "XPL-STAT"
        Case "XPL-TRIG"
        Case Else
