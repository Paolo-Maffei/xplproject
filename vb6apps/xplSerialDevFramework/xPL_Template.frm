...
Object = "{D9D65F26-40A3-4F6C-8DF0-998D98138058}#1.2#0"; "xPL.ocx"
...
Private Sub xPLSys_Received(Msg As xPL.xPLMsg)
    ...
    ' pass to com device
    If xPL_COMPassThru = True And Msg.Source <> "wmute-picbug.test" Then
...
lookfornextmsg:
    ...
    ' process input @@@
' routine here to process what comes in
' and turn it into a message for output to lan or whatever
...
Private Sub Form_Load()
    ...
    xPL_Source = "TONYT-DEVCOM" ' set vendor-device here @@@
    ...
    xPL_COMPassThru = True ' indicate if message should be passed straight thru @@@
    xPL_Ready = False
    xPL_Title = "COM Template" ' application title @@@
    Me.Caption = xPL_Title + " " + xPL_Source
