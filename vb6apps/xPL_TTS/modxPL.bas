...
Public xPL_Speech As SpVoice
Public xPL_Voices(32) As String
Public xPL_VoiceCount As Integer
Public xPL_Audios(16) As String
Public xPL_AudioCount As Integer
