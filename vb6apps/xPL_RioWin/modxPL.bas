...
Public Playing As Long
Public PlayNext As Long
Public Paused As Boolean
Public Random As Boolean
Public Volume As Integer

Public RioList() As String
Public RioListCount As Integer

Public Streams() As String
Public StreamUrls() As String
...
Public PlayingTags As TagsType
Public PlayNextTags As TagsType
