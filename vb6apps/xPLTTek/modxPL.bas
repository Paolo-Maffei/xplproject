...
' send message
Public Sub SendCommand(cmd As Long)

    Dim hwnd As Long
    
    hwnd = FindWindowEx(0, 0, "TTWndClass", vbNullString)
      
    Call SendMessageByLong(hwnd, WM_COMMAND, cmd, 0)
