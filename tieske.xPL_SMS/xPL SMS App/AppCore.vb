...
Public Class AppCore
    ...
    Friend Sub OnStartUp()
        ...
        xPLErrorLogFile = "C:\Users\Thijs\Documents\Visual Studio 2008\Projects\xPL SMS App\ServiceLog.txt"
        'Dim el As System.Diagnostics.EventLog() = System.Diagnostics.EventLog.GetEventLogs()
    ...
    Private Function HeartBeat(ByVal dev As xPL.xPLDevice) As xPL.xPLKeyValuePairs
        ...
        If SMSinterface.Credits Then
            ...
            LogError("SMS HeartBeat", "SMS credits; " & SMSinterface.LastCredits, EventLogEntryType.Information)
        Else
            ' failed
            kv.Value = Left(RemoveInvalidxPLchars("Error: " & SMSinterface.LastError, XPL_STRING_TYPES.Values), 80)
            LogError("SMS HeartBeat", "Error retreiving SMS credits; " & SMSinterface.LastError, EventLogEntryType.Error)
        End If
