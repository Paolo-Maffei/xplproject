...
-- <br/><br/>
-- This file is an xPL message handler for <code>x10.basic</code> messages.
...
-- <ol><li>x10 address</li>
-- <li>command</li>
-- <li>xpl message type (cmnd, trig, stat)</li>
-- <li>nil</li></ol>
-- <br/><br/>
...
local myNewHandler = {
	...
	ID = "X10basic",		-- enter a unique string to identify this handler
	...
	MessageHandler = function (self, msg, filter)
		...
		local dev = GetValueByKey('device')
		local cmd = GetValueByKey('command')
		local eventstring = typ .. ' ' .. prot .. '_' .. dev .. '_' .. cmd
		gir.TriggerEvent(eventstring, xPLEventDevice, dev, cmd, typ)
