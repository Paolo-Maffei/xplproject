...
#End Region
    ...
    Private Const XPL_LIB_VERSION As String = "4.4"
...
#Region "IP Communication, socket, msg sending"
    ...
    Private Sub ReceiveData(ByVal ar As IAsyncResult)
        ...
        If accept Then
            ...
            Try
                ...
                End If
            Catch ex As Exception
                LogError(ex.ToString() & vbCrLf & rawXpl & vbCrLf & HexDump(rawXpl))
            End Try
        End If
    ...
    Private Function HexDump(ByRef s As String) As String
